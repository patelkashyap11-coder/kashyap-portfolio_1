...
const media: MediaItem[] = [
  ...
  { src: '/products/IMG_9659.PNG', type: 'image', alt: 'Products' },
  { src: '/products/IMG_9660.PNG', type: 'image', alt: 'Products' },
  { src: '/products/IMG_9662.PNG', type: 'image', alt: 'Products' },
  { src: '/products/IMG_9665.PNG', type: 'image', alt: 'Products' },
  { src: '/products/IMG_9666.PNG', type: 'image', alt: 'Products' },
];
